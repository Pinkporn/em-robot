...
Add EM1-01
    ...
    Select Drop Down    Asset Name    ${VEHICLE}
...
Add EM2-07
    ...
    [Documentation]    
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Apr 2023    to date=Apr 2023    asset name=${VEHICLE}    
...
Add EM2-08
    ...
    [Documentation]    
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Apr 2023    to date=May 2023    asset name=${VEHICLE}    
    ...    fuel=${FUEL}    publisher=${PUBLISHER}    amount=100
    Save Emission
...
Add EM2-09
    ...
    [Documentation]    
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Apr 2023    to date=Jun 2023    asset name=${VEHICLE}    
    ...    fuel=${FUEL}    publisher=${PUBLISHER}    amount=100
    Save Emission
...
Add EM2-10
    ...
    [Documentation]    
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Apr 2023    to date=Oct 2023    asset name=${VEHICLE}    
    ...    fuel=${FUEL}    publisher=${PUBLISHER}    amount=100
    Save Emission
...
Add EM2-11
    ...
    [Documentation]    
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Jun 2023    to date=Jul 2023    asset name=${VEHICLE}    
    ...    fuel=${FUEL}    publisher=${PUBLISHER}    amount=100
    Save Emission
...
Add EM2-12
    ...
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Jun 2023    to date=Sep 2023    asset name=${VEHICLE}    
    ...    fuel=${FUEL}    publisher=${PUBLISHER}    amount=100
    Save Emission
...
Add EM2-13
    ...
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Jun 2023    to date=Oct 2023    asset name=${VEHICLE}    
    ...    fuel=${FUEL}    publisher=${PUBLISHER}    amount=100
    Save Emission
...
Add EM2-14
    ...
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Aug 2023    to date=Sep 2023    asset name=${VEHICLE}    
    ...    fuel=${FUEL}    publisher=${PUBLISHER}    amount=100
    Save Emission
...
Add EM2-15
    ...
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Aug 2023    to date=Dec 2023    asset name=${VEHICLE}    
    ...    fuel=${FUEL}    publisher=${PUBLISHER}    amount=100
    Save Emission
    Check Record Emission    scope 1=60.00 kg    scope 3=50.00 kg    outside of scope=30.00 kg
    Click Delete Emission
...
Add EM2-16
    ...
    [Documentation]    ช่วงที่เกินจาก Effective Date ให้ใช้ค่าเดิมต่อไป    
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Oct 2023    to date=Dec 2023    asset name=${VEHICLE}    
    ...    fuel=${FUEL}    publisher=${PUBLISHER}    amount=100
    Save Emission
    Check Record Emission    scope 1=60.00 kg    scope 3=50.00 kg    outside of scope=30.00 kg
    Click Delete Emission
...
Add EM2-17
    ...
    [Documentation]    ช่วงที่เกินจาก Effective Date ให้ใช้ค่าเดิมต่อไป    
    Add Emission Page 1 2    ${ORGANIZATION}    ${SITES}[0]    Fuel
    Enter Fuel Form    from date=Nov 2023    to date=Dec 2023    asset name=${VEHICLE}    
    ...    fuel=${FUEL}    publisher=${PUBLISHER}    amount=100
    Save Emission
    Check Record Emission    scope 1=60.00 kg    scope 3=50.00 kg    outside of scope=30.00 kg
    Click Delete Emission
