...
Add EM-24
    ...
    Click Add Emission Factor Button
    Enter Purchases Emission Factor Form    start date=Feb 2023    end date=Mar 2023    publisher=EF B    cert id=EFP-0024
    ...    factor type=Lifecycle    purchase group=Chemicals    goods and services=Good B
    ...    unit=kg    filling method=Total    Total=0.2
    Confirm Add EF Expect Different EF Type

Add EM-25
    [Documentation]    Duplicate Cert.
    Click Add Emission Factor Button
    Enter Purchases Emission Factor Form    start date=Feb 2023    end date=Mar 2023    publisher=EF B    cert id=EFP-002
    ...    factor type=Upstream    purchase group=Chemicals    goods and services=Good B
    ...    unit=kg    filling method=Total    Total=0.2
